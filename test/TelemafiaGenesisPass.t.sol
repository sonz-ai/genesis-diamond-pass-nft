...
contract TelemafiaGenesisPassTest is Test {
    TelemafiaGenesisPass public nft;
    ...
    string public supabaseUrl = "https://test-project.supabase.co";
    string public supabaseKey = "test-key";
    ...
    function setUp() public {
        ...
        // Deploy the contract
        nft = new TelemafiaGenesisPass(
            royaltyReceiver,
            "https://api.telemafia.com/metadata/",
            functionsRouter,
            donId,
            subscriptionId,
            callbackGasLimit,
    ...
    function testConstructor() public {
        ...
        assertEq(nft.supabaseUrl(), supabaseUrl);
        assertEq(nft.supabaseKey(), supabaseKey);
    }
