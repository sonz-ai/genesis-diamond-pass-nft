...
/**
 * @title SonzaiGenesisPass
 * @author Cline
 * @notice Production-ready ERC721C contract for Sonzai Diamond Genesis Pass NFT with whitelist and royalties.
 */
contract SonzaiGenesisPass is OwnableBasic, ERC721C, BasicRoyalties, ReentrancyGuard, FunctionsClient {
    ...
    /**
     * @notice Constructor for the Sonzai Diamond Genesis Pass NFT
